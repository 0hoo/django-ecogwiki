...
class YamlSchemaParserTest(WikiTestCase):
    ...
    def test_invalid(self):
        ...
        self.assertRaises(ValueError,
                          PageOperationMixin.parse_schema_yaml, u'.schema Book\n\n    #!yaml/schema\n    y: [1, 2\n')


class MetadataParserTest(WikiTestCase):
    def setUp(self):
        self.default_md = {
...
class WikiLinkParserTest(WikiTestCase):
    def test_plain(self):
...
class TitleToPathConvertTest(WikiTestCase):
...
class SimilarTitlesTest(WikiTestCase):
...
class DescriptionTest(WikiTestCase):
...
class SpecialTitlesTest(WikiTestCase):
    def test_years(self):
        titles = [
            u'10000 BCE',
            u'10000',
...
class HashbangTest(WikiTestCase):
    def setUp(self):
...
class TitleGroupingTest(WikiTestCase):
